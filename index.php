...
<body>
     ...
     <!--  <div class="col-md-5"></div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-12"> 
          <input type="submit" class="sub" value="Daftar"/>
        </div>
      </div>
...
<a style="font-weight:bold; " href="#" data-toggle="modal" data-target="#login">Admin Login</a></div>
<div class="col-md-3 box">
<a style="font-weight:bold;  href="#" data-toggle="modal" data-target="#developers">Developers</a>
</div>
</div>
